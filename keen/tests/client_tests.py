...
class ClientTests(BaseTestCase):
    def test_init(self):
        def positive_helper(project_token, **kwargs):
            ...
            self.assert_equal(project_token, client.project_token)
            return client
        ...
        # real strings for project token should work
        positive_helper("project_token")
        ...
        client = positive_helper("project_token")
        ...
        negative_helper(exceptions.InvalidPersistenceStrategyError,
                        "project_token", persistence_strategy="abc")
    ...
    def test_direct_persistence_strategy(self):
        project_token = "5004ded1163d66114f000000"
        client = KeenClient(project_token)
